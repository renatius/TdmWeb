...
tocTab[ir++] = new Array ("1", "Welcome", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("1.1", "Introduction", "introduction.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.2", "Compiling a Pattern", "compilingapattern.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.3", "Searching for a Pattern", "searchingforapattern.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.4", "Searching for a Pattern - DFA algorithm", "searchingforapatterndfa.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.5", "Grepping for a Pattern", "greppingforapattern.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.6", "Splitting a Text Using a Pattern", "splittingatextusingapatte.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.7", "Replacing All Occurences of a Pattern in a Target String", "replacingalloccurencesofa.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("1.8", "Replacement Strings", "replacementstrings.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("2", "Author", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("2.1", "Info", "info.htm", "", "cicon9.gif", "cicon9.gif");
isContent = true,
isIndex = false,
showNumbers = false,
...
function windowErr() {
isDyn = false;
hmtoc.location.href = "pcreworkbench_content.htm";
window.onerror = oldOnError;
}
function reDisplay(currentNumber,tocChange,noLink,e) {
if (isIndex && (hmtoc.location.href.substring(hmtoc.location.href.lastIndexOf("/")+1,hmtoc.location.href.length) != "pcreworkbench_kwindex.htm")) { isIndex=false; isContent=true; }
...
if (isContent && isDyn) {
hmtoc.document.write("\n\r\n\r<hr><font face=\"Arial,Helvetica\" size=\"1\">&copy; 2003 Renato Mancuso</font>\n\r</body>\n\r</html>\n\r");
